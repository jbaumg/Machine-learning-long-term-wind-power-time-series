...
setwd("C:/Users/Johann Baumgartner/Desktop/Uni/Doktorat/Paper 1/figures3/appendix/")
...
mlm1ts<-unlist(readRDS("C:/Users/Johann Baumgartner/Desktop/Uni/Doktorat/Paper 1/modelsresults/mlm2x206ts.rds"))
...
mlm2ts<-unlist(readRDS("C:/Users/Johann Baumgartner/Desktop/Uni/Doktorat/Paper 1/modelsresults/mlm3ts_60n.rds"))
...
errdtfr2<-as_tibble(data.frame(unique(errdt2$hour),with(errdt2, tapply(deviation, hour, mean)),with(errdt2, tapply(deviation, hour, min)),with(errdt2, tapply(deviation, hour, max)),rep("MLM2",24)))
names(errdtfr2)<-c("hour","mean","min","max", "type")

errdtfr3<-as_tibble(data.frame(unique(errdt3$hour),with(errdt3, tapply(deviation, hour, mean)),with(errdt3, tapply(deviation, hour, min)),with(errdt3, tapply(deviation, hour, max)),rep("MLM3",24)))
...
errdtfr2<-as_tibble(data.frame(unique(errdt2$hour),with(errdt2, tapply(deviation, hour, mean)),with(errdt2, tapply(deviation, hour, function(x){max(x)-min(x)})),rep("MLM2",24)))
names(errdtfr2)<-c("hour","mean","range", "type")

errdtfr3<-as_tibble(data.frame(unique(errdt3$hour),with(errdt3, tapply(deviation, hour, mean)),with(errdt3, tapply(deviation, hour, function(x){max(x)-min(x)})),rep("MLM3",24)))
...
#errdtfr2<-as_tibble(data.frame(unique(errdt2$hour),with(errdt2, tapply(deviation, hour, function(x){mean(abs(x))})),with(errdt2, tapply(deviation, hour, function(x){max(x)-min(x)})),rep("MLM2",24)))
#names(errdtfr2)<-c("hour","mean","range", "type")

#errdtfr3<-as_tibble(data.frame(unique(errdt3$hour),with(errdt3, tapply(deviation, hour, function(x){mean(abs(x))})),with(errdt3, tapply(deviation, hour, function(x){max(x)-min(x)})),rep("MLM3",24)))
#names(errdtfr3)<-c("hour","mean","range", "type")
...
errdtfr2<-as_tibble(data.frame(unique(errdt2$hour),with(errdt2, tapply(deviation, hour, function(x){median(abs(x))})),with(errdt2, tapply(deviation, hour, function(x){max(x)-min(x)})),rep("MLM2",24)))
names(errdtfr2)<-c("hour","median","range", "type")

errdtfr3<-as_tibble(data.frame(unique(errdt3$hour),with(errdt3, tapply(deviation, hour, function(x){median(abs(x))})),with(errdt3, tapply(deviation, hour, function(x){max(x)-min(x)})),rep("MLM3",24)))
...
errdtfrd2<-data.frame(errdt2,rep("MLM2",length(errdt2[,1])))
names(errdtfrd2)<-c("Deviation","Hour","Model")

errdtfrd3<-data.frame(errdt3,rep("MLM3",length(errdt3[,1])))
...
hdev<-ggplot(data = errdtfrdt3, aes(x=hour, y=deviation)) + geom_boxplot(aes(fill=type)) +facet_grid(.~type)
hdev
...
hdev2<-ggplot(data = errdtfrdt3, aes(x=Hour, y=Deviation)) + 
  ...
  scale_fill_manual(values=c("RN"="#c72321","MLM2"="#0d8085","MLM3"="#efc220"))+
...
dctd2<-data.frame(dct2,rep("MLM2",length(dct2[,1])))
names(dctd2)[5]<-c("type")

dctsd2<-data.frame(dcts2,rep("MLM2",length(dcts2[,1])))
names(dctsd2)[5]<-c("type")

dctspd2<-data.frame(dctsp2,rep("MLM2",length(dctsp2[,1])))
names(dctspd2)[5]<-c("type")

dctad2<-data.frame(dcta2,rep("MLM2",length(dcta2[,1])))
names(dctad2)[5]<-c("type")

dctwd2<-data.frame(dctw2,rep("MLM2",length(dctw2[,1])))
...
dctd3<-data.frame(dct3,rep("MLM3",length(dct3[,1])))
names(dctd3)[5]<-c("type")

dctsd3<-data.frame(dcts3,rep("MLM3",length(dcts3[,1])))
names(dctsd3)[5]<-c("type")

dctspd3<-data.frame(dctsp3,rep("MLM3",length(dctsp3[,1])))
names(dctspd3)[5]<-c("type")

dctad3<-data.frame(dcta3,rep("MLM3",length(dcta3[,1])))
names(dctad3)[5]<-c("type")

dctwd3<-data.frame(dctw3,rep("MLM3",length(dctw3[,1])))
...
dctp <- ggplot() +
  ...
  scale_fill_manual(values=c("Observations"="darkgrey", "RN"="#c72321","MLM2"="#0d8085","MLM3"="#efc220"))+
  theme_classic(base_size=30)+
  theme(legend.title = element_blank())+
  facet_grid(type~.)+
...
errdd3<-data.frame(errd3,rep("MLM3",length(errd3[,1])))
names(errdd3)<-c("obs","err","class","type")

errddab3<-data.frame(errdab3,rep("MLM3",length(errdab3[,1])))
names(errddab3)<-c("obs","err","class","type")

errdds3<-data.frame(errds3,rep("MLM3",length(errds3[,1])))
...
errddsp3<-data.frame(errdsp3,rep("MLM3",length(errdsp3[,1])))
names(errddsp3)<-c("obs","err","class","type")

errddw3<-data.frame(errdw3,rep("MLM3",length(errdw3[,1])))
...
errdda3<-data.frame(errda3,rep("MLM3",length(errda3[,1])))
...
errdd2<-data.frame(errd2,rep("MLM2",length(errd2[,1])))
names(errdd2)<-c("obs","err","class","type")

errddab2<-data.frame(errdab2,rep("MLM2",length(errdab2[,1])))
names(errddab2)<-c("obs","err","class","type")

errdds2<-data.frame(errds2,rep("MLM2",length(errds2[,1])))
...
errddsp2<-data.frame(errdsp2,rep("MLM2",length(errdsp2[,1])))
names(errddsp2)<-c("obs","err","class","type")

errddw2<-data.frame(errdw2,rep("MLM2",length(errdw2[,1])))
...
errdda2<-data.frame(errda2,rep("MLM2",length(errda2[,1])))
...
names(errdfx)<-c("medianRN","medianmlm2","medianmlm3","rangeRN","rangemlm2","rangemlm3")
...
names(errdfxw)<-c("meanRN","meanmlm1","meanmlm3","rangeRN","rangemlm1","rangemlm3")
...
names(errdfxw)<-c("medianRN","medianmlm1","medianmlm3","rangeRN","rangemlm1","rangemlm3")
...
names(errdfxs)<-c("meanRN","meanmlm1","meanmlm3","rangeRN","rangemlm1","rangemlm3")
...
jpeg(paste(getwd(),"/pdevtot.jpeg",sep = ""), width = 1000, height = 750)
pdevtot  
dev.off()
...
highg2<-data.frame(high2,rep("MLM2",length(high2[,1])))
names(highg2)<-c("breaks","Frequency","CF","type","type2")
highg2<-highg2[highg2$type=="Model",-5]
levels(highg2$type)<-c("MLM2", "Observations")
highg2$type[highg2$type=="RN"]<-"MLM2"

highg3<-data.frame(high3,rep("MLM3",length(high3[,1])))
names(highg3)<-c("breaks","Frequency","CF","type","type2")
highg3<-highg3[highg3$type=="Model",-5]
levels(highg3$type)<-c("MLM3", "Observations")
highg3$type[highg3$type=="RN"]<-"MLM3"
...
lowg2<-data.frame(low2,rep("MLM2",length(low2[,1])))
names(lowg2)<-c("breaks","Frequency","CF","type","type2")
lowg2<-lowg2[lowg2$type=="Model",-5]
levels(lowg2$type)<-c("MLM2", "Observations")
lowg2$type[lowg2$type=="Model"]<-"MLM2"

lowg3<-data.frame(low3,rep("MLM3",length(low3[,1])))
names(lowg3)<-c("breaks","Frequency","CF","type","type2")
lowg3<-lowg3[lowg3$type=="Model",-5]
levels(lowg3$type)<-c("MLM3", "Observations")
lowg3$type[lowg3$type=="Model"]<-"MLM3"
...
levels(highgg$type)<-c("Observations","RN","MLM2","MLM3")

lowgg<-rbind(lowg,lowg2,lowg3)
names(lowgg)<-c("breaks","Frequency","CF","type")
levels(lowgg$type)<-c("Observations","RN","MLM2","MLM3")
...
ts1m2<-data.frame(tsx12,rep("1h",length(tsx12)),rep("MLM2",length(tsx12)))
names(ts1m2)<-c("roc","tf","type")

ts1m3<-data.frame(tsx13,rep("1h",length(tsx13)),rep("MLM3",length(tsx13)))
...
ts3m2<-data.frame(tsx22,rep("3h",length(tsx22)),rep("MLM2",length(tsx22)))
names(ts3m2)<-c("roc","tf","type")

ts3m3<-data.frame(tsx23,rep("3h",length(tsx23)),rep("MLM3",length(tsx23)))
...
ts6m2<-data.frame(tsx32,rep("6h",length(tsx32)),rep("MLM2",length(tsx32)))
names(ts6m2)<-c("roc","tf","type")

ts6m3<-data.frame(tsx33,rep("6h",length(tsx33)),rep("MLM3",length(tsx33)))
...
ts12m2<-data.frame(tsx2,rep("12h",length(tsx2)),rep("MLM2",length(tsx2)))
names(ts12m2)<-c("roc","tf","type")

ts12m3<-data.frame(tsx3,rep("12h",length(tsx3)),rep("MLM3",length(tsx3)))
...
tst$type<-factor(as.character(tst$type), levels=c("RN","MLM2","MLM3","Observations"))
...
p6 <- ggplot() +
  ...
  scale_color_manual(values=c("Observations"="darkgrey","RN"="#c72321","MLM2"="#0d8085","MLM3"="#efc220"))
...
p20 <- ggplot() +
  ...
  geom_point(data=mod2y2[which(mod2y2$effekt<0.005),],aes(x=date,y=effekt, color="MLM2"))+
  geom_point(data=mod3y2[which(mod3y2$effekt<0.005),],aes(x=date,y=effekt, color="MLM3"))+
  theme_classic(base_size = 30)+
  theme(legend.title=element_blank())+
...
p20 <- ggplot() +
  ...
  geom_point(data=mod2[which(mod2$effekt[1:8760]<0.005),],aes(x=date,y=effekt, color="MLM2"))+
  geom_point(data=mod3[which(mod3$effekt[1:8760]<0.005),],aes(x=date,y=effekt, color="MLM3"))+
  theme_classic(base_size = 30)+
  theme(legend.title=element_blank())+
  xlab("Generation Hour")+
  ylab(paste(unit))+
...
p20x <- ggplot() +
  ...
  geom_point(data=mod2[which(mod2$effekt>0.005 & mod2$effekt<0.01),],aes(x=date,y=effekt, color="MLM2"))+
  geom_point(data=mod3[which(mod3$effekt>0.005 & mod3$effekt<0.01),],aes(x=date,y=effekt, color="MLM3"))+
  theme_classic(base_size = 30)+
  theme(legend.title=element_blank())+
  xlab("Generation Hour")+
  ylab(paste(unit))+
...
######## model ext values
t3<-readRDS("C:/Users/Johann Baumgartner/Desktop/Uni/Doktorat/Paper 1/modelsresults/mlm3model_60n.rds")
...
pstst2 <- ggplot() +
  geom_line(data=mod3[1:24,],aes(x=date,y=effekt, color="MLM3"),size=2)+
  geom_line(data=mod3tst,aes(x=date,y=effekt, color="MLM3min"),size=2)+
  geom_line(data=mod3tst2,aes(x=date,y=effekt, color="MLM3max"),size=2)+
  #geom_line(data=mod3tst3,aes(x=date,y=effekt, color="MLM3max"),size=2)+
  geom_line(data=mod3tst4,aes(x=date,y=effekt, color="MLM3rand"),size=2)+
  xlab("Generation Hour")+
  ylab(paste("CF"))+
  scale_x_datetime(labels = date_format("%H:%M"))+
  theme_classic(base_size = 30)+
  theme(legend.title=element_blank())+
  scale_color_manual(values=c("MLM3"="#efc220",
                              "MLM3min"="#ba9f7c",
                              "MLM3max"="#7a6952",
                              "MLM3rand"="#dfbf99"))
...
mod2xx<-data.frame(mod2,rep("MLM2",NROW(mod2)))
names(mod2xx)<-c("date","effekt","type")
mod3xx<-data.frame(mod3,rep("MLM3",NROW(mod3)))
names(mod3xx)<-c("date","effekt","type")

modx<-data.frame(mod,rep("RN",NROW(mod)),obs$effekt)
names(modx)<-c("date","effekt","type","obs")
mod2x<-data.frame(mod2,rep("MLM2",NROW(mod2)),obs$effekt)
names(mod2x)<-c("date","effekt","type","obs")
mod3x<-data.frame(mod3,rep("MLM3",NROW(mod3)),obs$effekt)
names(mod3x)<-c("date","effekt","type","obs")

xxc<-bind_rows(modx,mod2x,mod3x)
xxc$type<-factor(as.character(xxc$type), levels=c("RN","MLM2","MLM3","Observations"))

xxc2<-bind_rows(obsx,modxx,mod2xx,mod3xx)
xxc2$type<-factor(as.character(xxc2$type), levels=c("RN","MLM2","MLM3","Observations"))
...
pdevscat <- ggplot(data=xxc) +
  ...
  theme(legend.title=element_blank())+
  #theme(legend.position="none")+
  scale_colour_manual(values=c("RN"="#c72321","MLM2"="#0d8085","MLM3"="#efc220","Observations"="darkgrey"))+
  #facet_grid(.~type)+
...
dtest<-ggplot() +
  ...
  scale_fill_manual(breaks=c("RN", "MLM2", "MLM3", "Observations"),labels = c("RN", "MLM2", "MLM3", "Observations"),values = c("RN"="#c72321", "MLM2"="#0d8085", "MLM3"="#efc220", "Observations"="darkgrey"))+
  theme_classic(base_size=30)+
  theme(legend.title = element_blank())+
  xlab(paste(unit))+
  ylab("Density")
